...
export const VideoProvider = ({ children }) => {
    ...
    const handleSaveVideo = async (editedVideo) => {
        try {
            const response = await axios.put(`https://my-json-server.typicode.com/Wilmerd0/alura-flix-api/videos${editedVideo.id}`, editedVideo);
    ...
    const handleAddVideo = async (newVideo) => {
        try {
            const response = await axios.post('https://my-json-server.typicode.com/Wilmerd0/alura-flix-api/videos', newVideo);
    ...
    const handleDeleteVideo = async (videoId) => {
        try {
            await axios.delete(`https://my-json-server.typicode.com/Wilmerd0/alura-flix-api/videos${videoId}`);
